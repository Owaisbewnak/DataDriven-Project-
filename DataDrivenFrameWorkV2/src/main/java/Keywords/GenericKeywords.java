...
public class GenericKeywords {
	...
	public void reportFailure(String msg, boolean isCriticalFaliure) {
		logError(msg);
		takeScreenShot();
		softAssert.fail(msg);

		if (isCriticalFaliure) {
			Reporter.getCurrentTestResult().getTestContext().setAttribute("isCriticalFaliure", "true");
			reportAll();
		}
...
//		softAssert.fail(msg);
	...
	public void type(String locatorKey, String value) {
		logInfo("Typing Text : " + value + "-InLocator : " + prop.getProperty(locatorKey));
	...
	public void acceptAlert() {
		...
		logInfo("Accepting the Alert Successfully");
	}
